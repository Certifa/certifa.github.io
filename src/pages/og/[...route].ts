...
const FG_2: [number, number, number] = [154, 154, 154];
const FG_3: [number, number, number] = [106, 106, 106];
const FG_4: [number, number, number] = [72, 72, 72];
const LINE: [number, number, number] = [38, 38, 38];
...
export const GET: APIRoute = async ({ props }) => {
  ...
  const title = para(data.title, FG, 88, 'Bricolage Grotesque', 'Bold', { width: W - textX - PAD });
