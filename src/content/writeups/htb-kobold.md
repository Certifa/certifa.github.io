...
title: "Kobold"
date: 2026-03-15
tags: [linux, web, subdomain-enumeration, MCP, CVE-2026-23744, docker, privesc]
difficulty: easy
platform: HTB
description: "A wildcard TLS certificate leaks a subdomain running MCPJam Inspector v1.4.2, whose /api/mcp/connect endpoint executes attacker-supplied commands with no authentication. Privesc via docker group membership: reactivated with newgrp, then a container mount of the host filesystem to root."
featured: true
---
...
![Kobold Operations Suite landing page](/images/writeups/kobold/og.png)
...
![MCPJam Inspector interface](/images/writeups/kobold/mcp.png)
...
![Ollama configured as the managed LLM provider](/images/writeups/kobold/ollama.png)
...
![PrivateBin 2.0.2 on bin.kobold.htb](/images/writeups/kobold/bin.png)
...
- [CVE-2026-23744, MCPJam Inspector unauthenticated RCE](https://nvd.nist.gov/vuln/detail/CVE-2026-23744)
